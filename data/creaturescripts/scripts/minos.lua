local Minotaurs = {'minotaur', 'depowered minotaur', 'execowtioner', 'glooth powered minotaur', 'minotaur archer', 'minotaur bruiser', 'minotaur guard', 'minotaur hunter', 'minotaur mage', 'minotaur poacher', 'mooh\'tah warrior', 'moohtant', 'worm priestess', 'minotaur amazon'}
